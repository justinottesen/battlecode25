...
public class Bugpath {
    ...
    int minDistToTarget = 1000000000; //minimum distance I've been to the enemy while going around an obstacle
    ...
    boolean tryGreedyMove(){
        try {
            ...
            int dist1 = 1000000000, dist2 = 1000000000;
